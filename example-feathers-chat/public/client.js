...
<div class="card w-full max-w-sm bg-base-100 px-4 py-8 shadow-xl">
  ...
  <form class="card-body pt-2">
    ...
    <div class="form-control mt-6"><a href="/oauth/google" id="google" class="btn">Login with Google</a></div>
  </form>
</div>
</div>`
    ...
    userList.innerHTML += `<li class="user">
      <a>
        <div class="avatar indicator">
          <div class="w-6 rounded"><img src="${user.picture}" alt="${user.email}"></div>
